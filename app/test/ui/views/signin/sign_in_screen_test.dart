...
void main() {
  ...
  group('Sign in screen', () {
    ...
    testWidgets(
        'calls sign in with user credentials on sign in button clicked',
          ...
          find.widgetWithText(RaisedButton, "Sign In");
    ...
    testWidgets('navigate to sign up screen on button clicked',
            (WidgetTester tester) async {
          await pumpSignInScreen(tester);
          final dontHaveAnAccountButtonFinder =
          find.widgetWithText(TextButton, 'Do not have an account? Sign Up Here');
