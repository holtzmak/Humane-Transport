...
class LocalDB {
  ...
  Future<dynamic> saveTransporter(
      TransporterInfo tranRecord, String formId) async {
    var getDb = await db;
  ...
  Future<dynamic> updateTransporter(
      String formId, TransporterInfo updateRecord) async {
    var getDb = await db;
