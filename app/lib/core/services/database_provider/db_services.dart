...
class DatabaseServices {
  ...
  newForm(AnimalTransportRecord newRecord, String withInfo) async{
    ...
    await dbConnect.query(
        ...
        (?,?,?,?,?)''', [newRecord.vehicleInfo.animalsPerLoadingArea, newRecord.vehicleInfo.dateLoaded,
        newRecord.vehicleInfo.loadingArea, newRecord.vehicleInfo.loadingDensity, newRecord.vehicleInfo.timeLoaded]
    );
    ...
    await dbConnect.query(
        ...
        (?,?,?,?,?,?)''', [newRecord.deliveryInfo.additionalWelfareConcerns, newRecord.deliveryInfo.arrivalDate,
        newRecord.deliveryInfo.arrivalTime, newRecord.deliveryInfo.recInfo]
    );
